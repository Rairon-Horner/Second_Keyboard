...
--local keyboardIdentifier = '1832E231'
--local keyboardIdentifier = '16EE6FE1' --Клава ноута
...
sendToAHK = function (key)
      ...
      local file = io.open("C:\\Users\\rairo\\Desktop\\second_keyboard\\key.txt", "w") -- writing this string to a text file on disk is probably NOT the best method. Feel free to program something better!
